...
class Lamb(torch.optim.Optimizer):
    ...
    def step(self, closure=None):
        ...
        if self.grad_pre_normalization:
            ...
            self.log['global_grad_norm'] = self.global_grad_norm
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if len(state) == 0:
                    ...
                    # state['residual'] = torch.zeros_like(p.data)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                # self.mask_counter[p] = self.mask_counter[p] * (~mask) + 1
